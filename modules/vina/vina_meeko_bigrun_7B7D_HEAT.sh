...
#SBATCH -J array_vina_run_7B7D_HEAT
#SBATCH -p eight
...
run_name="array_7B7D_HEAT_all_mols"
...
export receptor_path="/mnt/ceph/keel4205/Vina/receptors/7B7D_72pH.pdbqt"
export config_vina_path="/mnt/ceph/keel4205/Vina/receptors/7B7D_HEAT_config.txt"
